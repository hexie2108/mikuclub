...
public class HomePrivateMessageController extends BaseController
{
        ...
        */
        ...
        {
                ((MessageDelegate) getDelegate()).getPrivateMessage(httpCallBack, getCurrentPage() + 1, true, null);
        }
        ...
        public void refreshPosts(final int page)
        {
                ...
                ((MessageDelegate) getDelegate()).getPrivateMessage(httpCallBack, 0, true, null);
        }
