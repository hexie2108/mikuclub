...
public class BottomDialogFrag extends BaseBottomSheetFrag {
        ...
        public void initView() {
               ...
               // layoutItemGroup = getActivity().findById(rootView, R.id.circle);
              //  txtBottomCancel = getActivity.findById(rootView, R.id.circle);
                ...
                for (int i = 0, size = titles.size(); i < size; i++) {
                        ...
                        if (!isBreak) {
                                TextView txtItem = (TextView) inflater.inflate(R.layout.test, layoutItemGroup, false);
