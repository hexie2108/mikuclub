...
public class HistoryActivity extends AppCompatActivity
{
        ...
        private void initController()
        {
                ...
                //确保浏览记录数组不是空的
                if(!PostPreferencesUtils.getHistoryPostIds().isEmpty()){
                        //参数设置只获取浏览记录数组里的文章id相关的文章
                        parameters.setInclude(PostPreferencesUtils.getHistoryPostIds());
                        //设置根据 文章id 来对结果进行排序
                ...
                //如果浏览记录为空 , 直接显示无内容错误
                        ...
                        recyclerViewAdapter.setNotMoreErrorMessage(ResourcesUtils.getString(R.string.history_empty_error));
